...
const { 
    ...
    updateArticle, deleteArticle, getBesoin, deleteBesoin, updateBesoin, getBesoinDetail, getSelectedArticle, addBesoin, getAllBesoin,
    ...
    getPrevision, addHistorique, getHistorique
...
app.post('/historique', function (req, res) {
    ...
    addHistorique(req, res,  HIST_PREV, HIST_BES, ANNEE);
})
